...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ho(e,t,n){let r=new Float32Array(eo),i=new G(0,1,0);return new Li({name:`SphericalGaussianBlur`,defines:{n:eo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:vo(),fragmentShader:`
...
</div>`,_u=function(e,t){var n=e[t];return Q.isArray(arguments[2])||Q.isObject(arguments[2])?new nu(e,t,arguments[2]):Q.isNumber(n)?Q.isNumber(arguments[2])&&Q.isNumber(arguments[3])?Q.isNumber(arguments[4])?new lu(e,t,arguments[2],arguments[3],arguments[4]):new lu(e,t,arguments[2],arguments[3]):Q.isNumber(arguments[4])?new su(e,t,{min:arguments[2],max:arguments[3],step:arguments[4]}):new su(e,t,{min:arguments[2],max:arguments[3]}):Q.isString(n)?new ru(e,t):Q.isFunction(n)?new uu(e,t,``):Q.isBoolean(n)?new tu(e,t):null};function vu(e){setTimeout(e,1e3/60)}var yu=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||vu,bu=function(){function e(){Hl(this,e),this.backgroundElement=document.createElement(`div`),Q.extend(this.backgroundElement.style,{backgroundColor:`rgba(0,0,0,0.8)`,top:0,left:0,display:`none`,zIndex:`1000`,opacity:0,WebkitTransition:`opacity 0.2s linear`,transition:`opacity 0.2s linear`}),$.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position=`fixed`,this.domElement=document.createElement(`div`),Q.extend(this.domElement.style,{position:`fixed`,display:`none`,zIndex:`1001`,opacity:0,WebkitTransition:`-webkit-transform 0.2s ease-out, opacity 0.2s linear`,transition:`transform 0.2s ease-out, opacity 0.2s linear`}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var t=this;$.bind(this.backgroundElement,`click`,function(){t.hide()})}return Ul(e,[{key:`show`,value:function(){var e=this;this.backgroundElement.style.display=`block`,this.domElement.style.display=`block`,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`,this.layout(),Q.defer(function(){e.backgroundElement.style.opacity=1,e.domElement.style.opacity=1,e.domElement.style.webkitTransform=`scale(1)`})}},{key:`hide`,value:function(){var e=this,t=function t(){e.domElement.style.display=`none`,e.backgroundElement.style.display=`none`,$.unbind(e.domElement,`webkitTransitionEnd`,t),$.unbind(e.domElement,`transitionend`,t),$.unbind(e.domElement,`oTransitionEnd`,t)};$.bind(this.domElement,`webkitTransitionEnd`,t),$.bind(this.domElement,`transitionend`,t),$.bind(this.domElement,`oTransitionEnd`,t),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform=`scale(1.1)`}},{key:`layout`,value:function(){this.domElement.style.left=window.innerWidth/2-$.getWidth(this.domElement)/2+`px`,this.domElement.style.top=window.innerHeight/2-$.getHeight(this.domElement)/2+`px`}}]),e}(),xu=jl(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);hu.inject(xu);var Su=`dg`,Cu=72,wu=20,Tu=`Default`,Eu=function(){try{return!!window.localStorage}catch{return!1}}(),Du=void 0,Ou=!0,ku=void 0,Au=!1,ju=[],Mu=function e(t){var n=this,r=t||{};this.domElement=document.createElement(`div`),this.__ul=document.createElement(`ul`),this.domElement.appendChild(this.__ul),$.addClass(this.domElement,Su),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],r=Q.defaults(r,{closeOnTop:!1,autoPlace:!0,width:e.DEFAULT_WIDTH}),r=Q.defaults(r,{resizable:r.autoPlace,hideable:r.autoPlace}),Q.isUndefined(r.load)?r.load={preset:Tu}:r.preset&&(r.load.preset=r.preset),Q.isUndefined(r.parent)&&r.hideable&&ju.push(this),r.resizable=Q.isUndefined(r.parent)&&r.resizable,r.autoPlace&&Q.isUndefined(r.scrollable)&&(r.scrollable=!0);var i=Eu&&localStorage.getItem(zu(this,`isLocal`))===`true`,a=void 0,o=void 0;if(Object.defineProperties(this,{parent:{get:function(){return r.parent}},scrollable:{get:function(){return r.scrollable}},autoPlace:{get:function(){return r.autoPlace}},closeOnTop:{get:function(){return r.closeOnTop}},preset:{get:function(){return n.parent?n.getRoot().preset:r.load.preset},set:function(e){n.parent?n.getRoot().preset=e:r.load.preset=e,Ku(this),n.revert()}},width:{get:function(){return r.width},set:function(e){r.width=e,Wu(n,e)}},name:{get:function(){return r.name},set:function(e){r.name=e,o&&(o.innerHTML=r.name)}},closed:{get:function(){return r.closed},set:function(t){r.closed=t,r.closed?$.addClass(n.__ul,e.CLASS_CLOSED):$.removeClass(n.__ul,e.CLASS_CLOSED),this.onResize(),n.__closeButton&&(n.__closeButton.innerHTML=t?e.TEXT_OPEN:e.TEXT_CLOSED)}},load:{get:function(){return r.load}},useLocalStorage:{get:function(){return i},set:function(e){Eu&&(i=e,e?$.bind(window,`unload`,a):$.unbind(window,`unload`,a),localStorage.setItem(zu(n,`isLocal`),e))}}}),Q.isUndefined(r.parent)){if(this.closed=r.closed||!1,$.addClass(this.domElement,e.CLASS_MAIN),$.makeSelectable(this.domElement,!1),Eu&&i){n.useLocalStorage=!0;var s=localStorage.getItem(zu(this,`gui`));s&&(r.load=JSON.parse(s))}this.__closeButton=document.createElement(`div`),this.__closeButton.innerHTML=e.TEXT_CLOSED,$.addClass(this.__closeButton,e.CLASS_CLOSE_BUTTON),r.closeOnTop?($.addClass(this.__closeButton,e.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):($.addClass(this.__closeButton,e.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),$.bind(this.__closeButton,`click`,function(){n.closed=!n.closed})}else{r.closed===void 0&&(r.closed=!0);var c=document.createTextNode(r.name);$.addClass(c,`controller-name`),o=Nu(n,c),$.addClass(this.__ul,e.CLASS_CLOSED),$.addClass(o,`title`),$.bind(o,`click`,function(e){return e.preventDefault(),n.closed=!n.closed,!1}),r.closed||(this.closed=!1)}r.autoPlace&&(Q.isUndefined(r.parent)&&(Ou&&=(ku=document.createElement(`div`),$.addClass(ku,Su),$.addClass(ku,e.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(ku),!1),ku.appendChild(this.domElement),$.addClass(this.domElement,e.CLASS_AUTO_PLACE)),this.parent||Wu(n,r.width)),this.__resizeHandler=function(){n.onResizeDebounced()},$.bind(window,`resize`,this.__resizeHandler),$.bind(this.__ul,`webkitTransitionEnd`,this.__resizeHandler),$.bind(this.__ul,`transitionend`,this.__resizeHandler),$.bind(this.__ul,`oTransitionEnd`,this.__resizeHandler),this.onResize(),r.resizable&&Uu(this),a=function(){Eu&&localStorage.getItem(zu(n,`isLocal`))===`true`&&localStorage.setItem(zu(n,`gui`),JSON.stringify(n.getSaveObject()))},this.saveToLocalStorageIfPossible=a;function l(){var e=n.getRoot();e.width+=1,Q.defer(function(){--e.width})}r.parent||l()};Mu.toggleHide=function(){Au=!Au,Q.each(ju,function(e){e.domElement.style.display=Au?`none`:``})},Mu.CLASS_AUTO_PLACE=`a`,Mu.CLASS_AUTO_PLACE_CONTAINER=`ac`,Mu.CLASS_MAIN=`main`,Mu.CLASS_CONTROLLER_ROW=`cr`,Mu.CLASS_TOO_TALL=`taller-than-window`,Mu.CLASS_CLOSED=`closed`,Mu.CLASS_CLOSE_BUTTON=`close-button`,Mu.CLASS_CLOSE_TOP=`close-top`,Mu.CLASS_CLOSE_BOTTOM=`close-bottom`,Mu.CLASS_DRAG=`drag`,Mu.DEFAULT_WIDTH=245,Mu.TEXT_CLOSED=`Close Controls`,Mu.TEXT_OPEN=`Open Controls`,Mu._keydownHandler=function(e){document.activeElement.type!==`text`&&(e.which===Cu||e.keyCode===Cu)&&Mu.toggleHide()},$.bind(window,`keydown`,Mu._keydownHandler,!1),Q.extend(Mu.prototype,{add:function(e,t){return Ru(this,e,t,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,t){return Ru(this,e,t,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var t=this;Q.defer(function(){t.onResize()})},destroy:function(){if(this.parent)throw Error(`Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.`);this.autoPlace&&ku.removeChild(this.domElement);var e=this;Q.each(this.__folders,function(t){e.removeFolder(t)}),$.unbind(window,`keydown`,Mu._keydownHandler,!1),Pu(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw Error(`You already have a folder in this GUI by the name "`+e+`"`);var t={name:e,parent:this};t.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed,t.load=this.load.folders[e]);var n=new Mu(t);this.__folders[e]=n;var r=Nu(this,n.domElement);return $.addClass(r,`folder`),n},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],Pu(e);var t=this;Q.each(e.__folders,function(t){e.removeFolder(t)}),Q.defer(function(){t.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display=`none`},show:function(){this.domElement.style.display=``},onResize:function(){var e=this.getRoot();if(e.scrollable){var t=$.getOffset(e.__ul).top,n=0;Q.each(e.__ul.childNodes,function(t){e.autoPlace&&t===e.__save_row||(n+=$.getHeight(t))}),window.innerHeight-t-wu<n?($.addClass(e.domElement,Mu.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-t-wu+`px`):($.removeClass(e.domElement,Mu.CLASS_TOO_TALL),e.__ul.style.height=`auto`)}e.__resize_handle&&Q.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+`px`}),e.__closeButton&&(e.__closeButton.style.width=e.width+`px`)},onResizeDebounced:Q.debounce(function(){this.onResize()},50),remember:function(){if(Q.isUndefined(Du)&&(Du=new bu,Du.domElement.innerHTML=gu),this.parent)throw Error(`You can only call remember on a top level GUI.`);var e=this;Q.each(Array.prototype.slice.call(arguments),function(t){e.__rememberedObjects.length===0&&Hu(e),e.__rememberedObjects.indexOf(t)===-1&&e.__rememberedObjects.push(t)}),this.autoPlace&&Wu(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||={},e.remembered[this.preset]=Gu(this)),e.folders={},Q.each(this.__folders,function(t,n){e.folders[n]=t.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=Gu(this),Fu(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[Tu]=Gu(this,!0)),this.load.remembered[e]=Gu(this),this.preset=e,Bu(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){Q.each(this.__controllers,function(t){this.getRoot().load.remembered?Lu(e||this.getRoot(),t):t.setValue(t.initialValue),t.__onFinishChange&&t.__onFinishChange.call(t,t.getValue())},this),Q.each(this.__folders,function(e){e.revert(e)}),e||Fu(this.getRoot(),!1)},listen:function(e){var t=this.__listening.length===0;this.__listening.push(e),t&&qu(this.__listening)},updateDisplay:function(){Q.each(this.__controllers,function(e){e.updateDisplay()}),Q.each(this.__folders,function(e){e.updateDisplay()})}});function Nu(e,t,n){var r=document.createElement(`li`);return t&&r.appendChild(t),n?e.__ul.insertBefore(r,n):e.__ul.appendChild(r),e.onResize(),r}function Pu(e){$.unbind(window,`resize`,e.__resizeHandler),e.saveToLocalStorageIfPossible&&$.unbind(window,`unload`,e.saveToLocalStorageIfPossible)}function Fu(e,t){var n=e.__preset_select[e.__preset_select.selectedIndex];n.innerHTML=t?n.value+`*`:n.value}function Iu(e,t,n){if(n.__li=t,n.__gui=e,Q.extend(n,{options:function(t){if(arguments.length>1){var r=n.__li.nextElementSibling;return n.remove(),Ru(e,n.object,n.property,{before:r,factoryArgs:[Q.toArray(arguments)]})}if(Q.isArray(t)||Q.isObject(t)){var i=n.__li.nextElementSibling;return n.remove(),Ru(e,n.object,n.property,{before:i,factoryArgs:[t]})}},name:function(e){return n.__li.firstElementChild.firstElementChild.innerHTML=e,n},listen:function(){return n.__gui.listen(n),n},remove:function(){return n.__gui.remove(n),n}}),n instanceof lu){var r=new su(n.object,n.property,{min:n.__min,max:n.__max,step:n.__step});Q.each([`updateDisplay`,`onChange`,`onFinishChange`,`step`,`min`,`max`],function(e){var t=n[e],i=r[e];n[e]=r[e]=function(){var e=Array.prototype.slice.call(arguments);return i.apply(r,e),t.apply(n,e)}}),$.addClass(t,`has-slider`),n.domElement.insertBefore(r.domElement,n.domElement.firstElementChild)}else if(n instanceof su){var i=function(t){if(Q.isNumber(n.__min)&&Q.isNumber(n.__max)){var r=n.__li.firstElementChild.firstElementChild.innerHTML,i=n.__gui.__listening.indexOf(n)>-1;n.remove();var a=Ru(e,n.object,n.property,{before:n.__li.nextElementSibling,factoryArgs:[n.__min,n.__max,n.__step]});return a.name(r),i&&a.listen(),a}return t};n.min=Q.compose(i,n.min),n.max=Q.compose(i,n.max)}else n instanceof tu?($.bind(t,`click`,function(){$.fakeEvent(n.__checkbox,`click`)}),$.bind(n.__checkbox,`click`,function(e){e.stopPropagation()})):n instanceof uu?($.bind(t,`click`,function(){$.fakeEvent(n.__button,`click`)}),$.bind(t,`mouseover`,function(){$.addClass(n.__button,`hover`)}),$.bind(t,`mouseout`,function(){$.removeClass(n.__button,`hover`)})):n instanceof du&&($.addClass(t,`color`),n.updateDisplay=Q.compose(function(e){return t.style.borderLeftColor=n.__color.toString(),e},n.updateDisplay),n.updateDisplay());n.setValue=Q.compose(function(t){return e.getRoot().__preset_select&&n.isModified()&&Fu(e.getRoot(),!0),t},n.setValue)}function Lu(e,t){var n=e.getRoot(),r=n.__rememberedObjects.indexOf(t.object);if(r!==-1){var i=n.__rememberedObjectIndecesToControllers[r];if(i===void 0&&(i={},n.__rememberedObjectIndecesToControllers[r]=i),i[t.property]=t,n.load&&n.load.remembered){var a=n.load.remembered,o=void 0;if(a[e.preset])o=a[e.preset];else if(a[Tu])o=a[Tu];else return;if(o[r]&&o[r][t.property]!==void 0){var s=o[r][t.property];t.initialValue=s,t.setValue(s)}}}}function Ru(e,t,n,r){if(t[n]===void 0)throw Error(`Object "`+t+`" has no property "`+n+`"`);var i=void 0;if(r.color)i=new du(t,n);else{var a=[t,n].concat(r.factoryArgs);i=_u.apply(e,a)}r.before instanceof Xl&&(r.before=r.before.__li),Lu(e,i),$.addClass(i.domElement,`c`);var o=document.createElement(`span`);$.addClass(o,`property-name`),o.innerHTML=i.property;var s=document.createElement(`div`);s.appendChild(o),s.appendChild(i.domElement);var c=Nu(e,s,r.before);return $.addClass(c,Mu.CLASS_CONTROLLER_ROW),i instanceof du?$.addClass(c,`color`):$.addClass(c,Vl(i.getValue())),Iu(e,c,i),e.__controllers.push(i),i}function zu(e,t){return document.location.href+`.`+t}function Bu(e,t,n){var r=document.createElement(`option`);r.innerHTML=t,r.value=t,e.__preset_select.appendChild(r),n&&(e.__preset_select.selectedIndex=e.__preset_select.length-1)}function Vu(e,t){t.style.display=e.useLocalStorage?`block`:`none`}function Hu(e){var t=e.__save_row=document.createElement(`li`);$.addClass(e.domElement,`has-save`),e.__ul.insertBefore(t,e.__ul.firstChild),$.addClass(t,`save-row`);var n=document.createElement(`span`);n.innerHTML=`&nbsp;`,$.addClass(n,`button gears`);var r=document.createElement(`span`);r.innerHTML=`Save`,$.addClass(r,`button`),$.addClass(r,`save`);var i=document.createElement(`span`);i.innerHTML=`New`,$.addClass(i,`button`),$.addClass(i,`save-as`);var a=document.createElement(`span`);a.innerHTML=`Revert`,$.addClass(a,`button`),$.addClass(a,`revert`);var o=e.__preset_select=document.createElement(`select`);if(e.load&&e.load.remembered?Q.each(e.load.remembered,function(t,n){Bu(e,n,n===e.preset)}):Bu(e,Tu,!1),$.bind(o,`change`,function(){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].innerHTML=e.__preset_select[t].value;e.preset=this.value}),t.appendChild(o),t.appendChild(n),t.appendChild(r),t.appendChild(i),t.appendChild(a),Eu){var s=document.getElementById(`dg-local-explain`),c=document.getElementById(`dg-local-storage`),l=document.getElementById(`dg-save-locally`);l.style.display=`block`,localStorage.getItem(zu(e,`isLocal`))===`true`&&c.setAttribute(`checked`,`checked`),Vu(e,s),$.bind(c,`change`,function(){e.useLocalStorage=!e.useLocalStorage,Vu(e,s)})}var u=document.getElementById(`dg-new-constructor`);$.bind(u,`keydown`,function(e){e.metaKey&&(e.which===67||e.keyCode===67)&&Du.hide()}),$.bind(n,`click`,function(){u.innerHTML=JSON.stringify(e.getSaveObject(),void 0,2),Du.show(),u.focus(),u.select()}),$.bind(r,`click`,function(){e.save()}),$.bind(i,`click`,function(){var t=prompt(`Enter a new preset name.`);t&&e.saveAs(t)}),$.bind(a,`click`,function(){e.revert()})}function Uu(e){var t=void 0;e.__resize_handle=document.createElement(`div`),Q.extend(e.__resize_handle.style,{width:`6px`,marginLeft:`-3px`,height:`200px`,cursor:`ew-resize`,position:`absolute`});function n(n){return n.preventDefault(),e.width+=t-n.clientX,e.onResize(),t=n.clientX,!1}function r(){$.removeClass(e.__closeButton,Mu.CLASS_DRAG),$.unbind(window,`mousemove`,n),$.unbind(window,`mouseup`,r)}function i(i){return i.preventDefault(),t=i.clientX,$.addClass(e.__closeButton,Mu.CLASS_DRAG),$.bind(window,`mousemove`,n),$.bind(window,`mouseup`,r),!1}$.bind(e.__resize_handle,`mousedown`,i),$.bind(e.__closeButton,`mousedown`,i),e.domElement.insertBefore(e.__resize_handle,e.domElement.firstElementChild)}function Wu(e,t){e.domElement.style.width=t+`px`,e.__save_row&&e.autoPlace&&(e.__save_row.style.width=t+`px`),e.__closeButton&&(e.__closeButton.style.width=t+`px`)}function Gu(e,t){var n={};return Q.each(e.__rememberedObjects,function(r,i){var a={},o=e.__rememberedObjectIndecesToControllers[i];Q.each(o,function(e,n){a[n]=t?e.initialValue:e.getValue()}),n[i]=a}),n}function Ku(e){for(var t=0;t<e.__preset_select.length;t++)e.__preset_select[t].value===e.preset&&(e.__preset_select.selectedIndex=t)}function qu(e){e.length!==0&&yu.call(window,function(){qu(e)}),Q.each(e,function(e){e.updateDisplay()})}var Ju=Mu;function Yu(e,t){let n=new Ju({width:320});n.domElement.id=`gui`;let r=n.addFolder(`Tower Dimensions`);r.add(e,`height`,50,300,1).name(`Height`).onChange(t),r.add(e,`baseRadius`,10,80,1).name(`Base Radius`).onChange(t),r.add(e,`topRadius`,1,30,1).name(`Top Radius`).onChange(t),r.open();let i=n.addFolder(`Hyperboloid Shape`);i.add(e,`twistAngle`,10,180,1).name(`Twist Angle (°)`).onChange(t),i.open();let a=n.addFolder(`Structure`);return a.add(e,`sectionCount`,1,10,1).name(`Section Count`).onChange(t),a.add(e,`strutCount`,6,48,2).name(`Strut Count`).onChange(t),a.add(e,`ringCount`,1,10,1).name(`Rings per Section`).onChange(t),a.add(e,`strutRadius`,.2,2,.1).name(`Strut Thickness`).onChange(t),a.add(e,`showRings`).name(`Show Rings`).onChange(t),a.open(),n}var Xu=`0.0.6`,Zu=document.getElementById(`version`);Zu&&(Zu.textContent=`v${Xu}`);var Qu={height:300,baseRadius:60,topRadius:5,sectionCount:6,strutCount:24,ringCount:4,strutRadius:.5,showRings:!0,twistAngle:50};function $u(){let e=new URLSearchParams(window.location.search);for(let{key:t,urlKey:n}of[{key:`height`,urlKey:`height`},{key:`baseRadius`,urlKey:`baseRadius`},{key:`topRadius`,urlKey:`topRadius`},{key:`sectionCount`,urlKey:`sectionCount`},{key:`ringCount`,urlKey:`ringCount`},{key:`twistAngle`,urlKey:`twistAngle`}]){let r=e.get(n);if(r!==null){let e=parseFloat(r);isNaN(e)||(Qu[t]=e)}}}$u();var ed=new Mn;ed.background=new J(1710638);var td=new ha(60,window.innerWidth/window.innerHeight,.1,1e3);td.position.set(100,200,300),td.lookAt(0,Qu.height/2,0);var nd=new rl({canvas:document.getElementById(`canvas`),antialias:!0});nd.setSize(window.innerWidth,window.innerHeight),nd.setPixelRatio(Math.min(window.devicePixelRatio,2)),nd.shadowMap.enabled=!0,nd.shadowMap.type=2;var rd=new pl(td,nd.domElement);rd.enableDamping=!0,rd.dampingFactor=.05,rd.target.set(0,Qu.height/2,0),rd.update();var id=new ya(16777215,.4);ed.add(id);var ad=new va(16777215,1);ad.position.set(50,100,50),ad.castShadow=!0,ad.shadow.mapSize.width=2048,ad.shadow.mapSize.height=2048,ad.shadow.camera.near=.5,ad.shadow.camera.far=500,ad.shadow.camera.left=-100,ad.shadow.camera.right=100,ad.shadow.camera.top=100,ad.shadow.camera.bottom=-100,ed.add(ad);var od=new ra(8900331,4013373,.3);ed.add(od);var sd=new La(300,30,4473924,3355443);ed.add(sd);var cd=new Yr(new Ei(300,300),new Oi({opacity:.3}));cd.rotation.x=-Math.PI/2,cd.receiveShadow=!0,ed.add(cd);var ld=null;function ud(){ld&&(Al(ld),ed.remove(ld)),ld=kl(Qu),ed.add(ld)}ud(),Yu(Qu,ud);function dd(){td.aspect=window.innerWidth/window.innerHeight,td.updateProjectionMatrix(),nd.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,dd);function fd(){requestAnimationFrame(fd),rd.update(),nd.render(ed,td)}fd();